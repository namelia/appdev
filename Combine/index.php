...
<!--js-->
	<script type="text/javascript" src="trial/js/clndr.js"></script>
	<script type="text/javascript" src="trial/js/underscore-min.js"></script>
	<script type="text/javascript" src="trial/js/moment-2.2.1.js"></script>
	<script type="text/javascript" src="trial/js/site.js"></script>


	<script type="text/javascript"  src="trial/js/jquery-2.1.1.min.js"></script>
      ...
      <div class="col-md-6 chit-chat-layer1-rit">
      	  <div class="geo-chart">
				...
				<div class="wrapper-flex">
					...
					<script src="trial/js/clndr.js"> </script>

				    <div class="col geo_main">
						<link rel="stylesheet" href="trial/css/clndr.css" type="text/css" />
						<script src="trial/js/underscore-min.js" type="text/javascript"></script>
						<script src= "trial/js/moment-2.2.1.js" type="text/javascript"></script>
						<script src="trial/js/clndr.js" type="text/javascript"></script>
						<script src="trial/js/site.js" type="text/javascript"></script>
...
<script type="text/javascript"  src="trial/js/bootstrap.js"> </script>
