...
?>
   ...
   <div class="mega card">
       ...
       <div class="header">
           ...
           <h1> Statistics </h1> <br>
           <h3> Want to know what objects are the most demanded ? <br> Which ones you should get more of ?</h3> <br>
       </div>

       <div class="containerr">
           <h4>For each category of objects (eg: Tablets, Phones...), you can see a list of companies (eg: Apple, Samsung) that sell that kind of objects. Next to those companies, you see a <strong>percentage</strong>. This shows you how <strong>successful/in demand</strong> this company's objects are at this point in time.<br><br> <i>For example, in the Phone category, if you see 90% next to Apple, it means that 90% of iPhones are currently used.</i> </h4>
           <br>
